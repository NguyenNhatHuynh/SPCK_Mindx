...
if (distance_to_object(obj_player) <= 200 && state == 0) {  
    ...
    var _bul = instance_create_layer(x, y, "Instances", obj_tancong3);
    with (_bul) {
        sprite_index = spr_tancong_3;  // Gán sprite cho mũi tên
    ...
    alarm[0] = room_speed * 0.5;  // Độ trễ 2 giây giữa các lần bắn
}
