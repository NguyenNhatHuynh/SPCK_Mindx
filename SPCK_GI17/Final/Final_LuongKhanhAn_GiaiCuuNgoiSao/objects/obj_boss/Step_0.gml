...
if (distance_to_object(obj_player) <= 300 && state == 0) {  
    ...
    var _bul = instance_create_layer(x, y, "Instances", obj_tancong_boss);
    with (_bul) {
        sprite_index = spr_tancong_boss;  // Gán sprite cho mũi tên
